                      ...
                      child: Row(
                        ...
                        children: [
                          TextButton(
                            ...
                            child: Text(
                              "LOGIN",
                              style: tabTextStyle.apply(color: selectedTab== loginTab ? Colors.white : Colors.white54),
                            ),
                          ),
                          TextButton(
                            onPressed: () {
                            ...
                            child: Text(
                              "SIGN UP",
                              style: tabTextStyle.apply(color: selectedTab== signupTab ? Colors.white : Colors.white54),
                            ),
                          )
                        ],
                      ),
                    ...
                    Expanded(
                      ...
                      child: SingleChildScrollView(
                        child: Padding(
                          ...
                          child:selectedTab==loginTab ? _Login(temedata: temedata): _SignUp(temedata: temedata),
                        ),
                      ),
                    ))
                  ],
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: temedata.textTheme.titleMedium!
    ...
    return TextField(
      ...
      decoration: InputDecoration(
          suffix: InkWell(
              ...
              }, child:  Text(obscureText ?  "Show" : "Hide",style: TextStyle(fontSize: 14,color: Theme.of(context).colorScheme.primary),)
          ),
